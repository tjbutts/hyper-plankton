# Excretion rate Plots_v2 # 
# Run GV_Excretion Rates.R first # 
# load tidyverse 
library(tidyverse)

# data sets for plotting  
mydat = gv19_zpcomm_excretionrate %>% 
  as.data.frame(gv19_zpcomm_excretionrate) %>% # nM/L N and P excretion grouped per day
  arrange(doy) 
mydat
...
plot(mydat$doy, mydat$N_comm_excretion_umol, type = 'o', lwd =3, 
     pch = 19, col = '#2a81ff', ylim = c(0, max(mydat$N_comm_excretion_umol+0.1)),
     ylab = 'Zoop N excretion (umol/L_d)', xlab = 'Day of Year, 2019', cex.lab = 1.5, cex.axis = 1.5)
...
windows(height= 5, width = 8)
par(mai=c(0.9,1,0.6,1))
plot(gv_uML_stocks$doy, gv_nM_stocks$inorgN_uML, type = 'o', lwd =3, 
     pch = 19, col = '#004ebe', 
     ylab = 'Nitrogen concentration (umol/L)', xlab = 'Day of Year, 2019', cex.lab = 1.5, cex.axis = 1.5)
...
par(new=T)
plot(mydat$doy, log(mydat$N_comm_excretion_umol+1), type='o', lwd=3, col = '#2a81ff', pch=19, yaxt='n', ylab ='', xlab = '',
...
par(mfrow = c(2,1), mai=c(0.9,1,1,0.1))
plot(mydat$doy, mydat$N_comm_excretion_umol, type = 'o', lwd =3, 
     pch = 19, col = '#2a81ff', ylim = c(0, 0.2),
     ylab = 'Zoop Nexcretion (umol/L-d)', xlab = 'Day of Year, 2019', cex.lab = 1.5, cex.axis = 1.5)
plot(mydat$doy, mydat$P_comm_excretion_umol, type = 'o', lwd =3, 
     pch = 19, col = '#d786e4', ylim = c(0,0.2),
     ylab = 'Zoop P excretion (umol/L_d)', xlab = 'Day of Year, 2019', cex.lab = 1.5, cex.axis = 1.5)

windows(height=6, width =9)
par(mai=c(0.9,1,0.6,1))
plot(mydat$doy, mydat$N_comm_excretion_umol, type = 'o', lwd =3, 
     pch = 19, col = '#2a81ff', ylim = c(0, 0.2),
     ylab = 'Zoop excretion (umol/L-d)', xlab = 'Day of Year, 2019', cex.lab = 1.5, cex.axis = 1.5)
points(mydat$doy, mydat$P_comm_excretion_umol, type = 'o', lwd =3, 
       pch = 19, col = '#d786e4')
legend('topright', legend = c('N excretion', 'P excretion'), pch = 19, cex = 1.5, col = c('#2a81ff', '#d786e4'))
