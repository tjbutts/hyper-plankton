...
gv19_arealexc_WP %>% filter(doy == 150)
gv19_arealexc_Hebert %>% filter(doy == 150)  
gv19_excretion_rate_daily_WP_OG %>% filter(doy == 150) # from GV_Excretion Rates_WP1994 Script
